...
class NovaStudioPolicy
{
    ...
    {
        return $user->can(NovaPermissions::STUDIOS_VIEW);
    }
    ...
    {
        return $user->can(NovaPermissions::STUDIOS_CREATE);
    }
    ...
    {
        return $user->can(NovaPermissions::STUDIOS_UPDATE);
    }
    ...
    {
        return $user->can(NovaPermissions::STUDIOS_DELETE);
    }
